...
const styles = StyleSheet.create({
    ...
    backBtn: { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(255,255,255,0.05)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    backBtnText: { color: '#ffb3c6', fontSize: 20, fontWeight: 'bold' },
    ...
    avatarShell: { width: 80, height: 80, borderRadius: 40, backgroundColor: 'rgba(158, 0, 49, 0.2)', borderWidth: 2, borderColor: '#9e0031', alignItems: 'center', justifyContent: 'center' },
    avatarText: { color: '#ffb3c6', fontSize: 32, fontWeight: '800' },
    heroInfo: { flex: 1, gap: 6 },
    heroName: { color: '#ffffff', fontSize: 22, fontWeight: '800' },
    onlinePill: { flexDirection: 'row', alignItems: 'center', gap: 6, alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 10, backgroundColor: 'rgba(16, 185, 129, 0.15)' },
    onlineDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#10b981' },
    onlineLabel: { color: '#10b981', fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
    heroCaption: { color: 'rgba(255,255,255,0.6)', fontSize: 12, lineHeight: 18 },

    // Tab bar
    tabBar: { flexDirection: 'row', backgroundColor: 'rgba(0,0,0,0.2)', borderTopWidth: 1, borderBottomWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    tabItem: { flex: 1, paddingVertical: 12, alignItems: 'center' },
    tabItemActive: { borderBottomWidth: 2, borderBottomColor: '#9e0031' },
    tabLabel: { color: 'rgba(255,255,255,0.5)', fontWeight: '600', fontSize: 14 },
    tabLabelActive: { color: '#ffb3c6' },
    ...
    botBubble: { alignSelf: 'flex-start', backgroundColor: 'rgba(255,255,255,0.08)', borderBottomLeftRadius: 4, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    userBubble: { alignSelf: 'flex-end', backgroundColor: '#9e0031', borderBottomRightRadius: 4 },
    bubbleRole: { fontSize: 10, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.6 },
    botRole: { color: '#ffb3c6' },
    userRole: { color: '#ffb3c6' },
    botText: { color: '#ffffff', fontSize: 15, lineHeight: 22 },
    ...
    inputArea: { flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: 'rgba(0,0,0,0.3)', borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.1)', gap: 10 },
    input: { flex: 1, minHeight: 44, maxHeight: 100, paddingHorizontal: 14, paddingTop: 12, paddingBottom: 12, borderRadius: 22, backgroundColor: 'rgba(255,255,255,0.05)', color: '#ffffff', fontSize: 15, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    sendBtn: { height: 44, paddingHorizontal: 18, justifyContent: 'center', borderRadius: 22, backgroundColor: '#9e0031' },
    sendBtnDisabled: { opacity: 0.4 },
    sendBtnText: { color: '#ffffff', fontWeight: '800', fontSize: 14 },

    // Voice
    voiceScroll: { padding: 24, alignItems: 'center', gap: 18 },
    voiceHint: { color: 'rgba(255,255,255,0.6)', fontSize: 14, textAlign: 'center', lineHeight: 22 },
    voiceDisclaimer: { color: 'rgba(255,255,255,0.4)', fontSize: 11, textAlign: 'center' },
    recordRing: { width: 136, height: 136, borderRadius: 68, borderWidth: 3, borderColor: '#9e0031', alignItems: 'center', justifyContent: 'center' },
    recordRingActive: { borderColor: '#ffb3c6' },
    recordBtn: { width: 108, height: 108, borderRadius: 54, backgroundColor: 'rgba(255,255,255,0.05)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    recordBtnActive: { backgroundColor: 'rgba(158, 0, 49, 0.4)' },
    recordBtnText: { color: '#ffffff', fontSize: 15, fontWeight: '700' },
    analysisCard: { width: '100%', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 20, overflow: 'hidden', gap: 12, paddingBottom: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    analysisBanner: { padding: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    analysisLabel: { fontSize: 17, fontWeight: '800', color: '#fff' },
    analysisScore: { fontSize: 14, fontWeight: '700' },
    analysisNote: { color: 'rgba(255,255,255,0.7)', fontSize: 14, lineHeight: 20, paddingHorizontal: 16 },
    suggestedHeader: { color: '#ffb3c6', fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, paddingHorizontal: 16 },

    // Resources
    resourcesScroll: { padding: 16, gap: 12 },
    resourceCard: { backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 16, padding: 14, gap: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
    ...
    resourceTitle: { color: '#ffffff', fontSize: 15, fontWeight: '700', flex: 1 },
    resourceDuration: { color: 'rgba(255,255,255,0.5)', fontSize: 12 },
    resourceDesc: { color: 'rgba(255,255,255,0.6)', fontSize: 13, lineHeight: 20 },
    stepsBox: { backgroundColor: 'rgba(0,0,0,0.2)', borderRadius: 12, padding: 12, gap: 6 },
    stepText: { color: '#cbd5e1', fontSize: 13, lineHeight: 20 },
    expandHint: { color: '#ffb3c6', fontSize: 12, fontWeight: '600' },
    emptyBox: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 30 },
    emptyText: { color: 'rgba(255,255,255,0.5)', textAlign: 'center', lineHeight: 22, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace' },
});
